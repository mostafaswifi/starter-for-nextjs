      ...
      <main className="bg-surface-container mx-auto mt-8 flex max-w-7xl rounded-lg shadow-sm">
        <aside className="h-full w-64 flex-col gap-4 border-r border-gray-200 bg-slate-50 p-6 lg:flex">
          ...
          <nav className="space-y-1">
            ...
            <div
              className={`flex cursor-pointer items-center gap-3 rounded-lg ${step === 1 ? "bg-gray-200" : ""} p-3 font-bold text-slate-500 transition-colors transition-transform duration-200 hover:translate-x-1 hover:text-blue-500`}
            >
            ...
            <div
              className={`flex cursor-pointer items-center gap-3 rounded-lg ${step === 2 ? "bg-gray-200" : ""} p-3 font-bold text-slate-500 transition-colors transition-transform duration-200 hover:translate-x-1 hover:text-blue-500`}
            >
              <span
            ...
            <div
              className={`flex cursor-pointer items-center gap-3 rounded-lg ${step === 3 ? "bg-gray-200" : ""} p-3 font-bold text-slate-500 transition-colors transition-transform duration-200 hover:translate-x-1 hover:text-blue-500`}
            >
              <span
                className="material-symbols-outlined"
          ...
          <button
            className="mt-8 rounded-lg bg-blue-700 px-4 py-3 text-sm font-semibold text-white transition-all hover:opacity-90"
            onClick={() => setStep(1)}
          >
            بدء طلب جديد
          </button>
        ...
        {step === 3 && <Print items={items} step={step} setStep={setStep} setItems={setItems} />}
